...
*/
    ...
    #define Throw( errcode, loglevel, ... ) do {                                \
        ...
        SPDLOG_LOGGER_CALL( sLogger, (spdlog::level::level_enum)loglevel, custom_msg); \
        throw except;                                                           \
    } while(0)


    #define Unreachable( ... ) \
        Throw( DRM_Assert, spdlog::level::err, "Reached an unexpected part of code: " + fmt::format(__VA_ARGS__ ) + "Please contact support." );
