...
def test_metering_limits_on_activate(accelize_drm, conf_json, cred_json, async_handler, log_file_factory, ws_admin):
    ...
    accelize_drm.pytest_fpga_env.clean_metering_env(cred_json, ws_admin)
    with accelize_drm.DrmManager(
                conf_json.path,
                cred_json.path,
                driver.read_register_callback,
...
def test_floating_limits(accelize_drm, conf_json, cred_json, async_handler, log_file_factory):
    ...
    """
    driver0 = accelize_drm.pytest_fpga_env.pytest_fpga_driver[0]
    driver1 = accelize_drm.pytest_fpga_env.pytest_fpga_driver[1]
