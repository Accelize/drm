...
**/
const std::vector<unsigned int> DrmControllerLibrary::DrmControllerDataConverter::hexStringToBinary(const std::string &hexString) {
...
**/
const std::string DrmControllerLibrary::DrmControllerDataConverter::binaryToHexString(const std::vector<unsigned int> &binary) {
...
*   \return Returns the hexadecimal representation.
**/
const std::string DrmControllerLibrary::DrmControllerDataConverter::binaryToHexString(const unsigned int &binary) {
...
**/
const std::string DrmControllerLibrary::DrmControllerDataConverter::binaryToVersionString(const unsigned int &binary) {
  // create a string stream
  std::stringstream stringStream;
...
*   \return Returns the list of binary values.
**/
const std::vector<unsigned int> DrmControllerLibrary::DrmControllerDataConverter::binStringToBinary(const std::string &binString) {
  // create the result vector
  std::vector<unsigned int> result;
...
**/
const std::string DrmControllerLibrary::DrmControllerDataConverter::binaryToBinString(const std::vector<unsigned int> &binary) {
  // create the result string
  std::string result("");
  // get each element from the input list
  for (std::vector<unsigned int>::const_iterator it = binary.begin(); it != binary.end(); it++) {
...
*   \return Returns the binary representation.
**/
const std::string DrmControllerLibrary::DrmControllerDataConverter::binaryToBinString(const unsigned int &binary) {
...
*   \return Returns the binary representation.
**/
const std::string DrmControllerLibrary::DrmControllerDataConverter::hexStringToBinString(const std::string &hexString) {
...
*   \return Returns the hexadecimal representation.
**/
const std::string DrmControllerLibrary::DrmControllerDataConverter::binStringToHexString(const std::string &binString) {
  // return the converted value
...
**/
const std::vector<unsigned int> DrmControllerLibrary::DrmControllerDataConverter::asciiStringToBinary(const unsigned char *asciiString, const unsigned int &asciiStringLen) {
  // create the result
  std::vector<unsigned int> result;
...
**/
unsigned char* DrmControllerLibrary::DrmControllerDataConverter::binaryToAsciiString(const std::vector<unsigned int> &binary, unsigned int &asciiStringLen) {
...
*   \return Returns the list of binary values.
**/
const std::vector<unsigned int> DrmControllerLibrary::DrmControllerDataConverter::base64ToBinary(const std::string &base64) {
  // converter string
...
**/
const std::string DrmControllerLibrary::DrmControllerDataConverter::binaryToBase64(const std::vector<unsigned int> &binary) {
...
*   \return Returns the hexadecimal representation.
**/
const std::string DrmControllerLibrary::DrmControllerDataConverter::base64ToHexString(const std::string &base64) {
  // return the converted value
...
*   \return Returns the base64 encoded string.
**/
const std::string DrmControllerLibrary::DrmControllerDataConverter::hexStringToBase64(const std::string &hexString) {
  // return the converted value
...
*   \return Returns the binary representation.
**/
const std::string DrmControllerLibrary::DrmControllerDataConverter::base64ToBinString(const std::string &base64) {
  // return the converted value
...
*   \return Returns the base64 encoded string.
**/
const std::string DrmControllerLibrary::DrmControllerDataConverter::binStringToBase64(const std::string &binString) {
  // return the converted value
...
**/
DrmControllerLibrary::DrmControllerDataConverter::DrmControllerDataConverter() {}
...
**/
bool DrmControllerLibrary::DrmControllerDataConverter::isBase64(unsigned char byte) {
