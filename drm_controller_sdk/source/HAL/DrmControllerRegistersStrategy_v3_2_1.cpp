...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v3_2_1::readAdaptativeProportionTestFailuresRegister(std::vector<unsigned int> &adaptativeProportionTestFailures) const {
 throwUnsupportedFeatureException("Adaptative Proportion Test Failures Registers", DRM_CONTROLLER_V3_2_1_SUPPORTED_VERSION);
...
unsigned int DrmControllerRegistersStrategy_v3_2_1::readPageRegister(unsigned int &page) const {
  return readRegister(DRM_CONTROLLER_V3_2_1_PAGE_REGISTER_NAME, page);
}
...
unsigned int DrmControllerRegistersStrategy_v3_2_1::writePageRegister(const unsigned int &page) const {
  ...
  return writeRegister(DRM_CONTROLLER_V3_2_1_PAGE_REGISTER_NAME, page);
}
...
*   \param[in] file is the stream to use for the data print.
**/
void DrmControllerRegistersStrategy_v3_2_1::printAdaptativeProportionTestFailuresHwReport(std::ostream &file) const { }
