...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v4_1_0::readAdaptativeProportionTestFailuresRegister(std::vector<unsigned int> &adaptativeProportionTestFailures) const {
 throwUnsupportedFeatureException("Adaptative Proportion Test Failures Registers", DRM_CONTROLLER_V4_1_0_SUPPORTED_VERSION);
...
*   \param[in] file is the stream to use for the data print.
**/
void DrmControllerRegistersStrategy_v4_1_0::printAdaptativeProportionTestFailuresHwReport(std::ostream &file) const { }
