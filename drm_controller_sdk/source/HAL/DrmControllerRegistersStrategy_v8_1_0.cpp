/**
*  \file      DrmControllerRegistersStrategy_v8_1_0.cpp
*  \version   8.1.0.0
*  \date      July 2022
*  \brief     Class DrmControllerRegistersStrategy_v8_1_0 defines strategy for register access of drm controller v8.1.0.
...
#include <HAL/DrmControllerRegistersStrategy_v8_1_0.hpp>
...
/** DrmControllerRegistersStrategy_v8_1_0
...
*              The function pointer shall have the following prototype "unsigned int f(const unsigned int&, unsigned int)".
**/
DrmControllerRegistersStrategy_v8_1_0::DrmControllerRegistersStrategy_v8_1_0(tDrmReadRegisterFunction readRegisterFunction,
...
: DrmControllerRegistersStrategyInterface(readRegisterFunction, writeRegisterFunction),
  mCommandRegisterWordNumber(numberOfWords(DRM_CONTROLLER_V8_1_0_COMMAND_SIZE)),
  mLicenseStartAddressRegisterWordNumber(numberOfWords(DRM_CONTROLLER_V8_1_0_LICENSE_START_ADDRESS_SIZE)),
  mLicenseTimerRegisterWordNumber(numberOfWords(DRM_CONTROLLER_V8_1_0_LICENSE_TIMER_SIZE)),
  mStatusRegisterWordNumber(numberOfWords(DRM_CONTROLLER_V8_1_0_STATUS_SIZE)),
  mErrorRegisterWordNumber(numberOfWords(DRM_CONTROLLER_V8_1_0_ERROR_SIZE)),
  mDnaRegisterWordNumber(numberOfWords(DRM_CONTROLLER_V8_1_0_DEVICE_DNA_SIZE)),
  mSaasChallengeRegisterWordNumber(numberOfWords(DRM_CONTROLLER_V8_1_0_SAAS_CHALLENGE_SIZE)),
  mSampledLicenseTimerCountRegisterWordNumber(numberOfWords(DRM_CONTROLLER_V8_1_0_LICENSE_TIMER_COUNTER_SIZE)),
  mVersionRegisterWordNumber(numberOfWords(DRM_CONTROLLER_V8_1_0_VERSION_SIZE)),
  mAdaptiveProportionTestFailuresRegisterWordNumber(numberOfWords(DRM_CONTROLLER_V8_1_0_ADAPTIVE_PROPORTION_TEST_FAILURES_SIZE)),
  mRepetitionCountTestFailuresRegisterWordNumber(numberOfWords(DRM_CONTROLLER_V8_1_0_REPETITION_COUNT_TEST_FAILURES_SIZE)),
  mVlnvWordRegisterWordNumber(numberOfWords(DRM_CONTROLLER_V8_1_0_VLNV_WORD_SIZE)),
  mLicenseWordRegisterWordNumber(numberOfWords(DRM_CONTROLLER_V8_1_0_LICENSE_WORD_SIZE)),
  mTraceWordRegisterWordNumber(numberOfWords(DRM_CONTROLLER_V8_1_0_TRACE_WORD_SIZE)),
  mMeteringWordRegisterWordNumber(numberOfWords(DRM_CONTROLLER_V8_1_0_METERING_WORD_SIZE)),
  mMailboxWordRegisterWordNumber(numberOfWords(DRM_CONTROLLER_V8_1_0_MAILBOX_WORD_SIZE)),
  mCommandRegisterStartIndex(0x0004>>2),
  ...
  mVlnvWordRegisterStartIndex(0x2004>>2),
  mLicenseWordRegisterStartIndex(0x4004>>2),
  mTraceWordRegisterStartIndex(0x6004>>2),
  mMeteringWordRegisterStartIndex(0x8004>>2),
  mMailboxWordRegisterStartIndex(0xA004>>2),
  mNumberOfTracesPerIp(DRM_CONTROLLER_V8_1_0_NUMBER_OF_TRACES_PER_IP),
  mVlnvNumberOfAdditionalWords(DRM_CONTROLLER_V8_1_0_VLNV_NUMBER_OF_ADDITIONAL_WORDS),
  mMeteringNumberOfAdditionalWords(DRM_CONTROLLER_V8_1_0_METERING_NUMBER_OF_ADDITIONAL_WORDS),
  mMailboxNumberOfAdditionalWords(DRM_CONTROLLER_V8_1_0_MAILBOX_NUMBER_OF_ADDITIONAL_WORDS),
  mLicenseFileHeaderWordNumber(DRM_CONTROLLER_V8_1_0_LICENSE_HEADER_BLOCK_SIZE),
  mLicenseFileIpBlockWordNumber(DRM_CONTROLLER_V8_1_0_LICENSE_IP_BLOCK_SIZE),
  mLicenseFileMinimumWordNumber((mLicenseFileHeaderWordNumber+mLicenseFileIpBlockWordNumber)*mLicenseWordRegisterWordNumber),
  mMeteringFileHeaderWordPosition(DRM_CONTROLLER_V8_1_0_METERING_FILE_HEADER_POSITION),
  mMeteringFileLicenseTimerCountWordPosition(DRM_CONTROLLER_V8_1_0_METERING_FILE_LICENSE_TIMER_COUNT_POSITION),
  mMeteringFileFirstIpMeteringDataWordPosition(DRM_CONTROLLER_V8_1_0_METERING_FILE_FIRST_IP_METERING_DATA_POSITION),
  mMeteringFileMacWordFromEndPosition(DRM_CONTROLLER_V8_1_0_METERING_FILE_MAC_FROM_END_POSITION),
  mDrmErrorRegisterMessagesArraySize(DRM_CONTROLLER_V8_1_0_NUMBER_OF_ERROR_CODES),
...
**/
DrmControllerRegistersStrategy_v8_1_0::~DrmControllerRegistersStrategy_v8_1_0()
{}
...
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::writeRegistersPageRegister() const {
	throwUnsupportedFeatureException("Write Registers Page Register", DRM_CONTROLLER_V8_1_0_SUPPORTED_VERSION);
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::writeVlnvFilePageRegister() const {
	throwUnsupportedFeatureException("Write Vlnv File Page Register", DRM_CONTROLLER_V8_1_0_SUPPORTED_VERSION);
	return mDrmApi_UNSUPPORTED_FEATURE_ERROR;
}
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::writeLicenseFilePageRegister() const {
	throwUnsupportedFeatureException("Write License File Page Register", DRM_CONTROLLER_V8_1_0_SUPPORTED_VERSION);
	return mDrmApi_UNSUPPORTED_FEATURE_ERROR;
}
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::writeTraceFilePageRegister() const {
	throwUnsupportedFeatureException("Write Trace File Page Register", DRM_CONTROLLER_V8_1_0_SUPPORTED_VERSION);
	return mDrmApi_UNSUPPORTED_FEATURE_ERROR;
}
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::writeMeteringFilePageRegister() const {
	throwUnsupportedFeatureException("Write Metering File Page Register", DRM_CONTROLLER_V8_1_0_SUPPORTED_VERSION);
	return mDrmApi_UNSUPPORTED_FEATURE_ERROR;
}
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::writeMailBoxFilePageRegister() const {
	throwUnsupportedFeatureException("Write MailBox File Page Register", DRM_CONTROLLER_V8_1_0_SUPPORTED_VERSION);
	return mDrmApi_UNSUPPORTED_FEATURE_ERROR;
}
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::writeNopCommandRegister() const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::writeDnaExtractCommandRegister() const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::writeVlnvExtractCommandRegister() const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::writeActivateCommandRegister() const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::writeEndSessionMeteringExtractCommandRegister() const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::writeMeteringExtractCommandRegister() const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::writeSampleLicenseTimerCounterCommandRegister() const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::writeLicenseTimerInitSemaphoreRequestCommandRegister(bool &licenseTimerInitSemaphoreRequest) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readLicenseStartAddressRegister(std::vector<unsigned int> &licenseStartAddress) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::writeLicenseStartAddressRegister(const std::vector<unsigned int> &licenseStartAddress) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readLicenseTimerInitRegister(std::vector<unsigned int> &licenseTimerInit) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::writeLicenseTimerInitRegister(const std::vector<unsigned int> &licenseTimerInit) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readDnaReadyStatusRegister(bool &dnaReady) const {
...
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::waitDnaReadyStatusRegister(const unsigned int &timeout, const bool &expected, bool &actual) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readVlnvReadyStatusRegister(bool &vlnvReady) const {
...
*   \throw DrmControllerTimeOutException whenever a timeout error occured. DrmControllerTimeOutException::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::waitVlnvReadyStatusRegister(const unsigned int &timeout, const bool &expected, bool &actual) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readActivationDoneStatusRegister(bool &activationDone) const {
...
*   \throw DrmControllerTimeOutException whenever a timeout error occured. DrmControllerTimeOutException::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::waitActivationDoneStatusRegister(const unsigned int &timeout, const bool &expected, bool &actual) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readAutonomousControllerEnabledStatusRegister(bool &autoEnabled) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readAutonomousControllerBusyStatusRegister(bool &autoBusy) const {
...
*   \throw DrmControllerTimeOutException whenever a timeout error occured. DrmControllerTimeOutException::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::waitAutonomousControllerBusyStatusRegister(const unsigned int &timeout, const bool &expected, bool &actual) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readMeteringEnabledStatusRegister(bool &meteringEnabled) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readMeteringReadyStatusRegister(bool &meteringReady) const {
...
*   \throw DrmControllerTimeOutException whenever a timeout error occured. DrmControllerTimeOutException::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::waitMeteringReadyStatusRegister(const unsigned int &timeout, const bool &expected, bool &actual) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readSaasChallengeReadyStatusRegister(bool &saasChallengeReady) const {
...
*   \throw DrmControllerTimeOutException whenever a timeout error occured. DrmControllerTimeOutException::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::waitSaasChallengeReadyStatusRegister(const unsigned int &timeout, const bool &expected, bool &actual) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readLicenseTimerEnabledStatusRegister(bool &licenseTimerEnabled) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readLicenseTimerInitLoadedStatusRegister(bool &licenseTimerInitLoaded) const {
...
*   \throw DrmControllerTimeOutException whenever a timeout error occured. DrmControllerTimeOutException::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::waitLicenseTimerInitLoadedStatusRegister(const unsigned int &timeout, const bool &expected, bool &actual) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readEndSessionMeteringReadyStatusRegister(bool &endSessionMeteringReady) const {
...
*   \throw DrmControllerTimeOutException whenever a timeout error occured. DrmControllerTimeOutException::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::waitEndSessionMeteringReadyStatusRegister(const unsigned int &timeout, const bool &expected, bool &actual) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readHeartBeatModeEnabledStatusRegister(bool &heartBeatModeEnabled) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readAsynchronousMeteringReadyStatusRegister(bool &asynchronousMeteringReady) const {
...
*   \throw DrmControllerTimeOutException whenever a timeout error occured. DrmControllerTimeOutException::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::waitAsynchronousMeteringReadyStatusRegister(const unsigned int &timeout, const bool &expected, bool &actual) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readLicenseTimerSampleReadyStatusRegister(bool &licenseTimerSampleReady) const {
...
*   \throw DrmControllerTimeOutException whenever a timeout error occured. DrmControllerTimeOutException::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::waitLicenseTimerSampleReadyStatusRegister(const unsigned int &timeout, const bool &expected, bool &actual) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readLicenseTimerCountEmptyStatusRegister(bool &licenseTimerCounterEmpty) const {
...
*   \throw DrmControllerTimeOutException whenever a timeout error occured. DrmControllerTimeOutException::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::waitLicenseTimerCountEmptyStatusRegister(const unsigned int &timeout, const bool &expected, bool &actual) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readSessionRunningStatusRegister(bool &sessionRunning) const {
...
*   \throw DrmControllerTimeOutException whenever a timeout error occured. DrmControllerTimeOutException::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::waitSessionRunningStatusRegister(const unsigned int &timeout, const bool &expected, bool &actual) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readActivationCodesTransmittedStatusRegister(bool &activationCodeTransmitted) const {
...
*   \throw DrmControllerTimeOutException whenever a timeout error occured. DrmControllerTimeOutException::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::waitActivationCodesTransmittedStatusRegister(const unsigned int &timeout, const bool &expected, bool &actual) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readLicenseNodeLockStatusRegister(bool &licenseNodeLock) const {
...
*   \throw DrmControllerTimeOutException whenever a timeout error occured. DrmControllerTimeOutException::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::waitLicenseNodeLockStatusRegister(const unsigned int &timeout, const bool &expected, bool &actual) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readLicenseMeteringStatusRegister(bool &licenseMetering) const {
...
*   \throw DrmControllerTimeOutException whenever a timeout error occured. DrmControllerTimeOutException::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::waitLicenseMeteringStatusRegister(const unsigned int &timeout, const bool &expected, bool &actual) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readSecurityAlertStatusRegister(bool &securityAlert) const {
...
*   \throw DrmControllerTimeOutException whenever a timeout error occured. DrmControllerTimeOutException::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::waitSecurityAlertStatusRegister(const unsigned int &timeout, const bool &expected, bool &actual) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readLicenseTimerInitSemaphoreAcknowledgeStatusRegister(bool &licenseTimerInitSemaphoreAcknowledge) const {
...
*   \throw DrmControllerTimeOutException whenever a timeout error occured. DrmControllerTimeOutException::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::waitLicenseTimerInitSemaphoreAcknowledgeStatusRegister(const unsigned int &timeout, const bool &expected, bool &actual) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readNumberOfLicenseTimerLoadedStatusRegister(unsigned int &numberOfLicenseTimerLoaded) const {
...
*   \throw DrmControllerTimeOutException whenever a timeout error occured. DrmControllerTimeOutException::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::waitNumberOfLicenseTimerLoadedStatusRegister(const unsigned int &timeout, const unsigned int &expected, unsigned int &actual) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readNumberOfDetectedIpsStatusRegister(unsigned int &numberOfDetectedIps) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readExtractDnaErrorRegister(unsigned char &dnaExtractError) const {
...
*   \throw DrmControllerTimeOutException whenever a timeout error occured. DrmControllerTimeOutException::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::waitExtractDnaErrorRegister(const unsigned int &timeout, const unsigned char &expected, unsigned char &actual) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readExtractVlnvErrorRegister(unsigned char &vlnvExtractError) const {
...
*   \throw DrmControllerTimeOutException whenever a timeout error occured. DrmControllerTimeOutException::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::waitExtractVlnvErrorRegister(const unsigned int &timeout, const unsigned char &expected, unsigned char &actual) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readActivationErrorRegister(unsigned char &activationError) const {
...
*   \throw DrmControllerTimeOutException whenever a timeout error occured. DrmControllerTimeOutException::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::waitActivationErrorRegister(const unsigned int &timeout, const unsigned char &expected, unsigned char &actual) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readLicenseTimerLoadErrorRegister(unsigned char &licenseTimerLoadError) const {
...
*   \throw DrmControllerTimeOutException whenever a timeout error occured. DrmControllerTimeOutException::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::waitLicenseTimerLoadErrorRegister(const unsigned int &timeout, const unsigned char &expected, unsigned char &actual) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readDnaRegister(std::vector<unsigned int> &dna) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readSaasChallengeRegister(std::vector<unsigned int> &saasChallenge) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readLicenseTimerCounterRegister(std::vector<unsigned int> &licenseTimerCounter) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readDrmVersionRegister(unsigned int &drmVersion) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readAdaptiveProportionTestFailuresRegister(std::vector<unsigned int> &adaptiveProportionTestFailures) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readRepetitionCountTestFailuresRegister(std::vector<unsigned int> &repetitionCountTestFailures) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readLogsRegister(const unsigned int &numberOfIps, std::vector<unsigned int> &logs) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readVlnvFileRegister(const unsigned int &numberOfIps, std::vector<unsigned int> &vlnvFile) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readVlnvFileRegister(const unsigned int &numberOfIPs, std::vector<std::string> &vlnvFile) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readLicenseFileRegister(const unsigned int &licenseFileSize, std::vector<unsigned int> &licenseFile) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readLicenseFileRegister(const unsigned int &licenseFileSize, std::string &licenseFile) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::writeLicenseFileRegister(const unsigned int &licenseFileSize, const std::vector<unsigned int> &licenseFile) const {
...
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::writeLicenseFileRegister(const std::string &licenseFile) const {
...
*          should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::clearLicenseFileRegister() const{
	std::string licenseFile;
	for(unsigned int i=0;i<mLicenseFileMinimumWordNumber;i++){
	  for(int k=0;k<DRM_CONTROLLER_SYSTEM_BUS_DATA_SIZE/4;k++){
		  licenseFile.push_back('0');
	  }
  }
	return writeLicenseFileRegister(licenseFile);
}
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readTraceFileRegister(const unsigned int &numberOfIps, std::vector<unsigned int> &traceFile) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readTraceFileRegister(const unsigned int &numberOfIPs, std::vector<std::string> &traceFile) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readMeteringFileRegister(const unsigned int &numberOfIps, std::vector<unsigned int> &meteringFile) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readMeteringFileRegister(const unsigned int &numberOfIPs, std::vector<std::string> &meteringFile) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readMailboxFileSizeRegister(unsigned int &readOnlyMailboxWordNumber, unsigned int &readWriteMailboxWordNumber) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readMailboxFileRegister(unsigned int &readOnlyMailboxWordNumber, unsigned int &readWriteMailboxWordNumber,
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::writeMailboxFileRegister(const std::vector <unsigned int> &readWriteMailboxData, unsigned int &readWriteMailboxWordNumber) const {
  // read mailbox
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::writeMailboxFileRegister(const std::vector<std::string> &readWriteMailboxData, unsigned int &readWriteMailboxWordNumber) const {
...
**/
void DrmControllerRegistersStrategy_v8_1_0::printMeteringFileHwReport(std::ostream &file) const {
...
**/
const char* DrmControllerRegistersStrategy_v8_1_0::getDrmErrorRegisterMessage(const unsigned char &errorRegister) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readPageRegister(unsigned int &page) const {
  return readRegister(DRM_CONTROLLER_V8_1_0_PAGE_REGISTER_INDEX, page);
}
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::writePageRegister(const unsigned int &page) const {
  return writeRegister(DRM_CONTROLLER_V8_1_0_PAGE_REGISTER_INDEX, page);
}
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readCommandRegister(unsigned int &command) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::writeCommandRegister(const unsigned int &command) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readStatusRegister(unsigned int &status) const {
...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::readErrorRegister(unsigned int &error) const {
...
**/
bool DrmControllerRegistersStrategy_v8_1_0::checkLicenseFileSize(const std::vector<unsigned int> &licenseFile) const {
...
*   \param[in] file is the stream to use for the data print.
**/
void DrmControllerRegistersStrategy_v8_1_0::printPageHwReport(std::ostream &file) const {
  unsigned int page(0);
...
*   \param[in] file is the stream to use for the data print.
**/
void DrmControllerRegistersStrategy_v8_1_0::printCommandHwReport(std::ostream &file) const {
...
*   \param[in] file is the stream to use for the data print.
**/
void DrmControllerRegistersStrategy_v8_1_0::printLicenseStartAddressHwReport(std::ostream &file) const {
...
*   \param[in] file is the stream to use for the data print.
**/
void DrmControllerRegistersStrategy_v8_1_0::printLicenseTimerHwReport(std::ostream &file) const {
...
*   \param[in] file is the stream to use for the data print.
**/
void DrmControllerRegistersStrategy_v8_1_0::printStatusHwReport(std::ostream &file) const {
...
*   \param[in] file is the stream to use for the data print.
**/
void DrmControllerRegistersStrategy_v8_1_0::printErrorHwReport(std::ostream &file) const {
...
**/
void DrmControllerRegistersStrategy_v8_1_0::printDrmVersionHwReport(std::ostream &file) const {
...
*   \param[in] file is the stream to use for the data print.
**/
void DrmControllerRegistersStrategy_v8_1_0::printDnaHwReport(std::ostream &file) const {
  std::string dna;
...
*   \param[in] file is the stream to use for the data print.
**/
void DrmControllerRegistersStrategy_v8_1_0::printSaasChallengeHwReport(std::ostream &file) const {
...
*   \param[in] file is the stream to use for the data print.
**/
void DrmControllerRegistersStrategy_v8_1_0::printAdaptiveProportionTestFailuresHwReport(std::ostream &file) const {
...
*   \param[in] file is the stream to use for the data print.
**/
void DrmControllerRegistersStrategy_v8_1_0::printRepetitionCountTestFailuresHwReport(std::ostream &file) const {
...
*   \param[in] file is the stream to use for the data print.
**/
void DrmControllerRegistersStrategy_v8_1_0::printLicenseTimerCounterHwReport(std::ostream &file) const {
...
*   \param[in] file is the stream to use for the data print.
**/
void DrmControllerRegistersStrategy_v8_1_0::printLogsHwReport(std::ostream &file) const {
  unsigned int numberOfDetectedIps;
  std::string logs;
  if (readNumberOfDetectedIpsStatusRegister(numberOfDetectedIps) != mDrmApi_NO_ERROR) return;
...
*   \param[in] file is the stream to use for the data print.
**/
void DrmControllerRegistersStrategy_v8_1_0::printVlnvFileHwReport(std::ostream &file) const {
  unsigned int numberOfDetectedIps;
...
*   \param[in] file is the stream to use for the data print.
**/
void DrmControllerRegistersStrategy_v8_1_0::printLicenseFileHwReport(std::ostream &file) const {
  unsigned int numberOfDetectedIps;
  std::string licenseFile;
...
*   \param[in] file is the stream to use for the data print.
**/
void DrmControllerRegistersStrategy_v8_1_0::printTraceFileHwReport(std::ostream &file) const {
  unsigned int numberOfDetectedIps;
...
*   \param[in] file is the stream to use for the data print.
**/
void DrmControllerRegistersStrategy_v8_1_0::printMailBoxFileHwReport(std::ostream &file) const {
  // read mailbox file
...
**/
std::vector<unsigned int> DrmControllerRegistersStrategy_v8_1_0::getMeteringFileHeader(const std::vector<unsigned int> &meteringFile) const {
...
**/
std::vector<unsigned int> DrmControllerRegistersStrategy_v8_1_0::getMeteringFileHeaderSessionId(const std::vector<unsigned int> &meteringFileHeader) const {
...
**/
bool DrmControllerRegistersStrategy_v8_1_0::getMeteringFileHeaderEncryptedMeteringFlag(const std::vector<unsigned int> &meteringFileHeader) const {
...
**/
bool DrmControllerRegistersStrategy_v8_1_0::getMeteringFileHeaderEndSessionMeteringFlag(const std::vector<unsigned int> &meteringFileHeader) const {
...
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::getMeteringFileHeaderEnvironmentId(const std::vector<unsigned int> &meteringFileHeader) const {
...
**/
unsigned int DrmControllerRegistersStrategy_v8_1_0::getMeteringFileHeaderSegmentIndex(const std::vector<unsigned int> &meteringFileHeader) const {
...
**/
std::vector<unsigned int> DrmControllerRegistersStrategy_v8_1_0::getMeteringFileLicenseTimer(const std::vector<unsigned int> &meteringFile) const {
...
**/
std::vector<unsigned int> DrmControllerRegistersStrategy_v8_1_0::getMeteringFileIpMeteringData(const std::vector<unsigned int> &meteringFile) const {
...
**/
std::vector<unsigned int> DrmControllerRegistersStrategy_v8_1_0::getMeteringFileMac(const std::vector<unsigned int> &meteringFile) const {
