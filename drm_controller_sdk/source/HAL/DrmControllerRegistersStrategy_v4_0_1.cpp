...
*   \throw DrmControllerUnsupportedFeature whenever the feature is not supported. DrmControllerUnsupportedFeature::what() should be called to get the exception description.
**/
unsigned int DrmControllerRegistersStrategy_v4_0_1::readAdaptativeProportionTestFailuresRegister(std::vector<unsigned int> &adaptativeProportionTestFailures) const {
 throwUnsupportedFeatureException("Adaptative Proportion Test Failures Registers", DRM_CONTROLLER_V4_0_1_SUPPORTED_VERSION);
...
*   \param[in] file is the stream to use for the data print.
**/
void DrmControllerRegistersStrategy_v4_0_1::printAdaptativeProportionTestFailuresHwReport(std::ostream &file) const { }
