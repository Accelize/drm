...
: DrmControllerRegistersStrategyInterface(readRegisterFunction, writeRegisterFunction),
  ...
  mVlnvWordRegisterStartIndex(0x2000>>2),
  mLicenseWordRegisterStartIndex(0x4000>>2),
  mTraceWordRegisterStartIndex(0x6000>>2),
  mMeteringWordRegisterStartIndex(0x8000>>2),
  mMailboxWordRegisterStartIndex(0xA000>>2),
