...
: DrmControllerRegistersStrategyInterface(readRegisterFunction, writeRegisterFunction),
  ...
  mVlnvWordRegisterStartIndex(0x800),
  mLicenseWordRegisterStartIndex(0x1000),
  mTraceWordRegisterStartIndex(0x1800),
  mMeteringWordRegisterStartIndex(0x2000),
  mMailboxWordRegisterStartIndex(0x2800),
